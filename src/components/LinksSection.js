      ...
      <div className="p-5 text-center bg-body-tertiary">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-3 col-sm-12">
              <a href="https://github.com/anuvihas-sk" target="_blank" rel="noopener noreferrer">
            ...
            <div className="col-lg-3 col-sm-12">
              <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" width="56" height="46" fill="Black" className="bi bi-substack" viewBox="0 0 16 16">
